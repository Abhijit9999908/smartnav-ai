...
Release signing now reads from `android/keystore.properties` or these environment variables:

- `SMARTNAV_STORE_FILE`
- `SMARTNAV_STORE_PASSWORD`
- `SMARTNAV_KEY_ALIAS`
- `SMARTNAV_KEY_PASSWORD`

You can start from `android/keystore.properties.example` and keep the real file out of version control.
